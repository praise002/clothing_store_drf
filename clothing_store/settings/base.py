...
STORE_MANAGER_EMAIL = config("STORE_MANAGER_EMAIL")
STORE_MANAGER_PASSWORD = config("STORE_MANAGER_PASSWORD")
CONTENT_EDITOR_EMAIL = config("CONTENT_EDITOR_EMAIL")
CONTENT_EDITOR_PASSWORD = config("CONTENT_EDITOR_PASSWORD")
CUSTOMER_SUPPORT_EMAIL = config("CUSTOMER_SUPPORT_EMAIL")
CUSTOMER_SUPPORT_PASSWORD = config("CUSTOMER_SUPPORT_PASSWORD")
